...
from cross_initialization.models.clip_model import CLIPTextModel
...
from cross_initialization.textual_inversion_dataset import TextualInversionDataset
from cross_initialization.utils import *
import json

from cross_initialization.utils import load_train_config
# ------------------------------------------------------------------------------
...
def train(train_config):
    ...
    # load train config if not having id text embeddings
    args = load_train_config(train_config, args)
